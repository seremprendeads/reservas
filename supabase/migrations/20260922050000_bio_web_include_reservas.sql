-- ============================================================================
-- Plan 4 (bio_web · "Bio Pro + Sitio web") incluye Reservas.
--
-- El plan mantiene su nombre e identidad ("Bio Pro + Sitio web"), pero ya
-- no bloquea el modulo Reservas: bio_web pasa a otorgar bio, landing y
-- reservas. No se toca ningun otro plan.
-- ============================================================================
