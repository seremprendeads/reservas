...
import { SUPPORT_WHATSAPP, whatsappLink } from './plans';
...
// la función SQL set_trial_end_date() (migración 20260919000000_trial_16_days.sql).
...
export const PLAN_MODULES: Record<string, ModuleId[]> = {
  ...
  // Plan 4 · Bio Pro + Sitio web (incluye reservas)
