          ...
          <div className="relative flex items-start gap-4">
            <div className="flex-1 text-center">
              <div className="flex items-center gap-2 mb-2">
                ...
                Con el Plan Pro el cliente recibe la confirmación por WhatsApp <span className="font-semibold text-white">AUTOMATICAMENTE AL PAGAR</span><br></br> sin intervención manual, <span className="font-semibold text-white">24 hs, 7 días, feriados incluidos.</span>
              </p>
               </div>
            </div>
          </div>
