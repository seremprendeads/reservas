...
// Regla: si un dato no fue cargado por el negocio, no se muestra ni se inventa.
  ...
  return (
    <>
      <p className="text-[15px] leading-7 text-foreground">
        Esta política explica qué datos personales recibe {name} a través de esta página, para qué los usa
      ...
      <Section title="Quién es responsable de tus datos">
        ...
        <p>
          ...
          página, gestionar reservas y vender online. BookingBio trata los datos por cuenta del negocio y solo
          para prestar el servicio de la plataforma.
        </p>
      </Section>

      <Section title="Qué datos podés proporcionar">
        <List items={[
          <><strong className="text-foreground">Al reservar un turno:</strong> nombre, teléfono, email, el servicio elegido, la fecha y el horario, y el estado del pago cuando corresponde.</>,
          <><strong className="text-foreground">Al anotarte en la lista de espera:</strong> nombre, teléfono, email, la fecha y el horario deseados y el servicio que te interesa.</>,
          <><strong className="text-foreground">Al comprar en la tienda:</strong> nombre, email, teléfono y el detalle del pedido (productos, talles, cantidades y montos).</>,
          <><strong className="text-foreground">Al completar otros formularios o escribir al negocio:</strong> la información que decidas enviar.</>,
          <><strong className="text-foreground">Al navegar:</strong> datos técnicos básicos, como la dirección IP y el tipo de navegador, que los servicios de alojamiento registran para funcionar y protegerse.</>,
        ]} />
        <p>
      ...
      <Section title="Para qué se usan">
        <List items={[
          'Registrar, confirmar y administrar tus reservas y pedidos.',
          'Enviarte confirmaciones y comunicarse con vos por temas relacionados con tu reserva, tu compra o tu lugar en la lista de espera.',
          'Procesar los pagos que realices online.',
          'Cumplir obligaciones legales, contables o impositivas del negocio.',
          'Mantener la seguridad de la página y prevenir usos indebidos.',
        ]} />
        <p>
      ...
      <Section title="Con quién se comparten">
        ...
        <List items={[
          ...
          'Supabase, para la base de datos y el almacenamiento de archivos.',
          'Vercel, para el alojamiento del sitio web.',
          'Mercado Pago, cuando realizás un pago online.',
          'Un servicio de envío de correos electrónicos, para las confirmaciones.',
          'Google Calendar, si el negocio sincroniza su agenda con ese servicio.',
        ]} />
      ...
      <Section title="Tus derechos">
        <p>
          ...
          fines que no sean necesarios para tu reserva o compra. Para hacerlo, comunicate con el
          responsable <ContactLinks d={d} />.
        </p>
        {ar && (
          <>
            <p>
...
function CookiesPolicy({ d }: { d: PublicLegalInfo }) {
  ...
  return (
    <>
      <p className="text-[15px] leading-7 text-foreground">
        Esta política explica qué cookies y tecnologías similares pueden usarse cuando visitás la página de {name}.
      </p>
      ...
      <Section title="Almacenamiento necesario para que la página funcione">
        ...
        <List items={[
          'Recordar qué negocio estás visitando.',
          'Guardar los productos que agregaste al carrito de la tienda.',
          'Recordar tus preferencias de visualización.',
          'No volver a mostrarte un aviso emergente que ya cerraste durante la visita.',
        ]} />
      ...
      <Section title="Servicios de terceros incluidos en la página">
        <List items={[
          <><strong className="text-foreground">Mercado Pago:</strong> la página carga su herramienta de pagos, que puede usar cookies o identificadores propios con fines de seguridad y prevención de fraude.</>,
          <><strong className="text-foreground">Google Fonts:</strong> se usa para mostrar tipografías. Al cargarlas, tu navegador se conecta con servidores de Google.</>,
        ]} />
      </Section>
      ...
      <Section title="Cómo controlarlas">
        <p>
          ...
          Si los bloqueás, algunas funciones, como el carrito de la tienda, pueden dejar de funcionar.
        </p>
...
function BookingConditions({ d }: { d: PublicLegalInfo }) {
  ...
  return (
    <>
      <p className="text-[15px] leading-7 text-foreground">
        Estas condiciones se aplican a las reservas de turnos y a las compras que realizás a {name} a través de
        esta página.
      </p>
      ...
      <Section title="Quién presta el servicio">
        ...
        <List items={[
          ...
          'establece los precios, los horarios y la disponibilidad;',
          'acepta o rechaza las reservas según sus propias condiciones;',
          'responde por la información que publica;',
          'responde por la relación comercial con sus clientes.',
        ]} />
      </Section>

      <Section title="El rol de BookingBio">
        <p>
          BookingBio proporciona la plataforma tecnológica que {name} usa para crear su página, gestionar
          reservas, cobrar online y otras funcionalidades que haya contratado. BookingBio no presta los servicios
          ni vende los productos del negocio, no fija sus precios ni condiciones y no es parte de la relación
          comercial entre vos y {name}.
        </p>
      ...
      <Section title="Precios y pagos">
        <p>
          Los precios y la moneda los define {name} y son los que se muestran al momento de reservar o comprar.
      ...
      <Section title="Contacto">
        <p>Para cualquier consulta o reclamo sobre tu reserva o compra, comunicate con {name} <ContactLinks d={d} />.</p>
