...
export function MasterLoginScreen({ onLogin }: Props) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4 dark:bg-gray-950">
      <div className="w-full max-w-md">
        <div className="mb-12 text-center">
          ...
          <h1 className="text-3xl font-display text-foreground">BookingBio Master</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2.5">
                ...
                <Input
                  ...
                  required
                  placeholder="master@bookingbio.lat"
        ...
        <p className="mt-8 text-center text-sm text-foreground/40">BookingBio · Acceso restringido</p>
      </div>
    </div>
  );
}
