...
const SIDEBAR_GROUPS = [
  ...
  { id: 'engagement', label: 'Engagement', icon: Heart, tabs: ['gallery', 'banner', 'shop_invite', 'testimonials', 'faq', 'cta', 'plans', 'map', 'popup'] as AdminTab[] },
                                  ...
                                  return (
                                    <div key={subGroup.id} className="space-y-1">
                                      <button
                                        ...
                                        className="flex w-full items-center justify-between text-xs font-display tracking-wide text-muted-foreground hover:text-foreground py-1 px-2 rounded-lg transition-colors"
                                      >
