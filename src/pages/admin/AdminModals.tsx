...
import { whatsappLink } from '../../modules/subscription';
import {
          ...
          <div className="px-6 -mt-4">
            ...
            <div className="flex flex-col gap-3 py-5">
              <Button
                ...
                asChild
              >
                <a href={whatsappLink('Hola! Mi prueba de BookingBio esta por vencer y quiero elegir un plan.')} target="_blank" rel="noopener noreferrer">Actualizar Plan</a>
              </Button>
